...
@Service
public class CuidadosDeEnfermeriaServiceImpl implements CuidadosDeEnfermeriaService{

	@Autowired
	private CuidadosDeEnfermeriaRepository cuidadosDeEnfermeriaRepository;
	
	public CuidadosDeEnfermeria create(CuidadosDeEnfermeria cuidadosDeEnfermeria) throws ValidationException {		
		return cuidadosDeEnfermeriaRepository.save(cuidadosDeEnfermeria);		
	}
	
	@Override
	public List<CuidadosDeEnfermeria> getCuidadosDeEnfermeriaByPaciente(String identificacion) {
		 return cuidadosDeEnfermeriaRepository
		 	.findAll()
		 	.stream()
